...
So, *design pillars*. You might have heard developers talk about design pillars. They're a useful, abstract device that you can build the rest of the game on and deliver on the experience that the designers want. In any sort of product design, you might also hear *'promise pillars'* thrown around. In promise-based marketing, a product/brand/company will be advertised to deliver on a promise. This is the experience that the thing in question is committed to delivering. When the experience isn't delivered, that promise isn't met. Games are all about delivering promises. In Skyrim, the promise is to make you feel like you're a fantasy hero in a seamless world. In Dance Dance Revolution, the promise is to feel like you're an awesome dancer. This experience is communicated through a game's mechanics. 

```A game can also gain a life of its own outside of this promise, but that's outside the scope of this blog.```
